...
static SEXP _pkgrcpp_approx2_pi_try(SEXP NSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const int >::type N(NSEXP);
    rcpp_result_gen = Rcpp::wrap(approx2_pi(N));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _pkgrcpp_approx2_pi(SEXP NSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_pkgrcpp_approx2_pi_try(NSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _pkgrcpp_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("double(*approx2_pi)(const int)");
...
RcppExport SEXP _pkgrcpp_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("pkgrcpp", "_pkgrcpp_approx2_pi", (DL_FUNC)_pkgrcpp_approx2_pi_try);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_pkgrcpp_approx2_pi", (DL_FUNC) &_pkgrcpp_approx2_pi, 1},
